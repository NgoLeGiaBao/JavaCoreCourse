...
public class MenuView extends JFrame {
	...
	private ButtonGroup buttonGroupMainDishes;
	...
	private ArrayList arrayListSideDishes;
	...
	public ButtonGroup getButtonGroupMainDishes() {
		return buttonGroupMainDishes;
	}
	public void setButtonGroupMainDishes(ButtonGroup buttonGroupMainDishes) {
		this.buttonGroupMainDishes = buttonGroupMainDishes;
	}
	...
	public ArrayList <JCheckBox> getArrayListSideDishes() {
		return arrayListSideDishes;
	}
	public void setArrayListSideDishes(ArrayList arrayListSideDishes) {
		this.arrayListSideDishes = arrayListSideDishes;
	}
	public void initialInterface () {
		...
		jRadioButtonRice.setFont(fontSmall);
		jRadioButtonPho = new JRadioButton("PHO");
		jRadioButtonPho.setFont(fontSmall);
		jRadioButtonBread = new JRadioButton("BREAD");
		jRadioButtonBread.setFont(fontSmall);
		
		// Group JRadionButton
		buttonGroupMainDishes = new ButtonGroup();
		buttonGroupMainDishes.add(jRadioButtonRice);
		buttonGroupMainDishes.add(jRadioButtonPho);
		buttonGroupMainDishes.add(jRadioButtonBread);
		
		jPanelListMainDishes.add(jRadioButtonRice);
		jPanelListMainDishes.add(jRadioButtonPho);
		jPanelListMainDishes.add(jRadioButtonBread);
		
		jPanelMainDishes.setLayout(new GridLayout(2,1));
		jPanelMainDishes.add(jLabelMainDishesTitle);
		jPanelMainDishes.add(jPanelListMainDishes);
		...
		// Group JCheckBox
		arrayListSideDishes = new ArrayList<JCheckBox>();
		arrayListSideDishes.add(jCheckMilkTea);
		arrayListSideDishes.add(jCheckCocacola);
		arrayListSideDishes.add(jCheckBoxCake);
		arrayListSideDishes.add(jCheckBoxNem);
		
		jPanelListSideDishes.add(jCheckMilkTea);
		jPanelListSideDishes.add(jCheckCocacola);
		jPanelListSideDishes.add(jCheckBoxCake);
		jPanelListSideDishes.add(jCheckBoxNem);
		
		jPanelSideDishes.setLayout(new GridLayout(2,1));
		jPanelSideDishes.add(jLabelSideDishesTitle);
		jPanelSideDishes.add(jPanelListSideDishes);
